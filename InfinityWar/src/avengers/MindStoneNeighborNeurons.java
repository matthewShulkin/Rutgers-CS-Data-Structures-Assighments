...
// I started here
        ...
        int rowCol = StdIn.readInt() - 1;
        
//this reads the first #rowCol letters but those dont really matter to me
...
//this now matters
        ...
        // StdOut.setFile(MindStoneNeighborNeuronsOutputFile);
        // StdOut.print(map.get("x"));



        // String msn[][] = new String[rowCol2][2];

        // StdOut.setFile(MindStoneNeighborNeuronsOutputFile);

        // for(int x=0; x < rowCol2; x++){
        //     for(int y=0; y<2;y++){

        //     msn[x][y] = StdIn.readString();
        //         if(y =='x'){
        //             StdOut.print(x);
        //              }
        //         }
        ...
        // String[] singleArray = new String[rowCol];
        ...
        // String msn[][] = new String[rowCol][rowCol];

        // for(int x=0; x < rowCol2; x++){
        //     for(int y=0; y<rowCol2; y++){
